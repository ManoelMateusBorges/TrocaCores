"use strict";
const colors = ["red", "green", "blue", "rgba(140.210.50)"];
const elementColor = document.querySelector("#bgColor");
const btnChangeColor = document.querySelector("#btnCgColor");
const textColor = document.querySelector("#textColor");
btnChangeColor.addEventListener("click", () => {
    let numberColor = randomGererator();
    if (numberColor == 3) {
